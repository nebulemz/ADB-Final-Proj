  ...
  <div class="container-fluid">
    ...
    <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="dashboard.php"><?php 
      ...
      if(isHaveTextInUrl("dashboard")) {
        echo $admin->admin_name. " " ."Dashboard";
      } else if (isHaveTextInUrl("hrm")) {
        echo "hrm";
      }
      else if (isHaveTextInUrl("customes")) {
        echo "All customers";
      } else if (isHaveTextInUrl("products")) {
        echo "all products";
      } else if (isHaveTextInUrl("orders")) {
        echo "all orders";
      } else if (isHaveTextInUrl("payments")) {
        echo "payments";
      } else if (isHaveTextInUrl("receipts")) {
        echo "All receipts";
      }

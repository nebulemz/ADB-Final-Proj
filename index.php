    ...
    <div class="form-container">
      ...
      <div class="form-inner-container">
        <div class="btn-container">
          <button type="button" class="toggle-btn btn__admin">Admin</button>
          <button type="button" class="toggle-btnn toggle-btn btn__staff"
            onclick="document.location.href='second_index.php'">Staff</button>
        </div>
